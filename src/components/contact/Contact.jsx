...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
            .sendForm('service_e4e04jf', 'template_98u49ma', formRef.current, {
                publicKey: '4ggbym6GxcUR5Nggt',
            })
            .then(
                () => {
                    setSuccess(true)
    ...
    return (
        <motion.div ref={ref} className='contact' variants={variants} initial="initial" whileInView="animate">
            <motion.div className="textContainer" variants={variants}> {/* Wrapped in motion.div */}
                ...
                <motion.div className="phoneSvg"
                    ...
                    <svg width="450px"
                        ...
                        <motion.path
                            ...
                            animate={isInView && { pathLength: 1 }}  // Fixed typo here
                            transition={{ duration: 2 }}
                            className="c"  // Fixed typo here
